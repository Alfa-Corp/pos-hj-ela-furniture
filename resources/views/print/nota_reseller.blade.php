    ...
    <div class="content">
        ...
        <div class="transaction">
            <table class="transaction-table" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="text-align: left" colspan="5">PRODUK</td>
                ...
                @foreach ($transaction->reseller_transaction_details()->get() as $item)
                <tr>
                    <td class='name' style='text-align: left' colspan="5">{{ Str::upper($item->product->title)  }}</td>
