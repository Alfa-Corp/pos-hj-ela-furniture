<template>
    <Head>
        <title>Forgot Password - Pujasari Jaya Mandiri</title>
    </Head>
    <div class="col-md-4">
        <div class="fade-in">
            <div class="text-center mb-4">
                <a href="" class="text-dark text-decoration-none">
                    ...
                    <h3 class="mt-2 font-weight-bold">Sistem Kasir</h3>
                    <h3 class="mt-2 font-weight-bold">Pujasari Jaya Mandiri</h3>
                </a>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="submit">
                            <div class="input-group mb-3">
                                ...
                                <input v-model="form.email" :class="{ 'is-invalid': errors.email }" type="email" class="form-control" placeholder="Email">
                            </div>
