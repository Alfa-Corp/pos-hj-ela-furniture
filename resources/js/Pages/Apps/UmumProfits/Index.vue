<template>
    <Head>
        <title>Laporan Profits Umum - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a :href="`/apps/umum_profits/export?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-success btn-md border-0 shadow me-3"><i class="fa fa-file-excel"></i> EXCEL</a>
                                        <a :href="`/apps/umum_profits/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-secondary btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
                                    </div>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="profit in profits" :key="profit.id">
                                                ...
                                                <td class="text-center">{{ profit.umum_transaction.invoice }}</td>
                                                <td class="text-center">{{ profit.umum_transaction.customer_id ? profit.umum_transaction.customer.name : 'Umum' }}</td>
    ...
    export default {
        ...
        setup() {
            ...
            const filter = () => {
                ...
                Inertia.get('/apps/umum_profits/filter', {
