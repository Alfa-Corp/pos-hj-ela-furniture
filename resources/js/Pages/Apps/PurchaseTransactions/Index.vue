<template>
    <Head>
        <title>Pembelanjaan - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button v-if="hasAnyPermission(['purchase_transactions.order'])" @click.prevent="storeTransaction" class="btn btn-purple btn-md border-0 shadow text-uppercase me-2" :disabled="cash < grandTotal || grandTotal <= 0 ">Order Pembelanjaan & Print</button>

                                    <button v-if="hasAnyPermission(['purchase_transactions.retur'])" @click.prevent="storeTransaction" class="btn btn-danger btn-md border-0 shadow text-uppercase" :disabled="cash > grandTotal ||grandTotal >= 0">Retur Pembelanjaan & Print</button>
                                </div>
                            </div>
                        </div>
