<template>
    <Head>
        <title>Laporan Profits Reseller - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-chart-line"></i> LAPORAN PROFITS</span>
                            </div>
                            <div class="card-body">
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a :href="`/apps/reseller_profits/export?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-success btn-md border-0 shadow me-3"><i class="fa fa-file-excel"></i> EXCEL</a>
                                        <a :href="`/apps/reseller_profits/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-secondary btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
                                    </div>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="profit in profits" :key="profit.id">
                                                ...
                                                <td class="text-center">{{ profit.reseller_transaction.invoice }}</td>
                                                <td class="text-center">{{ profit.reseller_transaction.customer_id ? profit.reseller_transaction.customer.name : 'Umum' }}</td>
    ...
    export default {
        ...
        setup() {
            ...
            const filter = () => {
                ...
                Inertia.get('/apps/reseller_profits/filter', {
