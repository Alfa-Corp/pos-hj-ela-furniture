<template>
    <Head>
        <title>Edit Satuan Barang - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" v-model="form.name" :class="{ 'is-invalid': errors.name }" type="text" placeholder="Nama Satuan Barang">
                                    </div>
            ...
            const submit = () => {
                ...
                Inertia.post(`/apps/unit_of_measurement/${props.unit_of_measurement.id}`, {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Satuan Barang updated successfully.',
                            icon: 'success',
