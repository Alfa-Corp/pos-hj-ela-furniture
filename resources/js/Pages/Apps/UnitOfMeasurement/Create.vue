<template>
    <Head>
        <title>Buat Baru Satuan Produk - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-folder"></i> BUAT BARU SATUAN</span>
                            </div>
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" v-model="form.name" :class="{ 'is-invalid': errors.name }" type="text" placeholder="Nama">
                                    </div>
            ...
            const submit = () => {
                ...
                Inertia.post('/apps/unit_of_measurement', {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Satuan Barang saved successfully.',
                            icon: 'success',
