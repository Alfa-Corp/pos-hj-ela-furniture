<template>
    <Head>
        <title>Suppliers - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        <Link href="/apps/suppliers/create" v-if="hasAnyPermission(['suppliers.create'])" class="btn btn-primary input-group-text"> <i class="fa fa-plus-circle me-2"></i> BUAT BARU</Link>
            ...
            const destroy = (id) => {
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        Inertia.delete(`/apps/suppliers/${id}`);
