<template>
    <Head>
        <title>Buat Baru Supplier - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-user-circle"></i> BUAT BARU SUPPLIER</span>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.name_company" :class="{ 'is-invalid': errors.name_company }" type="text" placeholder="Nama Supplier">
                                            </div>
