                            ...
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="fw-bold">Satuan Barang</label>
    ...
    export default {
        ...
        setup(props) {
            ...
            const form = reactive({
                ...
                sell_price_reseller: props.product.sell_price_reseller,
                sell_price_umum: props.product.sell_price_umum,
                stock: props.product.stock,
                is_favorite: props.product.is_favorite == '1',
            ...
            const update = () => {
                ...
                form.is_favorite = form.is_favorite ? '1' : '0';
