<template>
    <Head>
        <title>Users - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        ...
                                        <Link href="/apps/users/create" v-if="hasAnyPermission(['users.create'])" class="btn btn-primary input-group-text"> <i class="fa fa-plus-circle me-2"></i> BUAT BARU</Link>
