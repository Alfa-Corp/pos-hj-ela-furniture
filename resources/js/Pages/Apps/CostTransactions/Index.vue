<template>
    <Head>
        <title>Transaksi Pengeluaran - Sistem Kasir</title>
    </Head>
    <main class="c-main">
                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control text-center" v-model="name_cost" placeholder="Nama Pengeluaran">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Harga</label>
                                    <input type="number" class="form-control text-center" v-model="price_per_qty" placeholder="Harga">
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button @click.prevent="storeTransaction" class="btn btn-purple btn-md border-0 shadow text-uppercase">Tambah Pengeluaran</button>
                                </div>
                            </div>
                        </div>
